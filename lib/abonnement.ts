/** Offres d'abonnement : deux niveaux, paiement au mois avec une remise de 1 % par mois payé d'un coup. */
export type Niveau = 'standard' | 'premium'

export const NIVEAUX: Record<Niveau, { nom: string; prixMensuel: number }> = {
  standard: { nom: 'Standard', prixMensuel: 10000 },
  premium: { nom: 'Premium', prixMensuel: 12500 },
}
