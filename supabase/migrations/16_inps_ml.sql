-- D-AGROBUSINESS — Mali : cotisations INPS, AMO et taxe ANPE (source : CLEISS, taux au 1er janvier 2025).
-- Les organisations maliennes déjà créées rechargent le modèle depuis RH > Paramètres, puis revalident.
