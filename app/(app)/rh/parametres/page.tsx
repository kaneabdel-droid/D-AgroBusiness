      ...
      <div className="mb-6 flex flex-wrap gap-2">
        <SimpleCreateForm
          ...
          champs={[
            ...
            { name: 'ricf_mode', label: 'Réduction pour charges de famille', type: 'select', required: true, defaultValue: param?.ricf_mode ?? 'parts', options: [{ value: 'parts', label: 'Selon le nombre de parts (tableau ci-dessous)' }, { value: 'familial', label: 'Pourcentage de l’impôt : taux marié + taux par enfant' }, { value: 'abattement_base', label: 'Abattement sur la base selon le nombre de charges (tableau ci-dessous, Niger)' }, { value: 'charges_impot', label: 'Pourcentage de l’impôt selon le nombre de charges (tableau ci-dessous, Burkina Faso)' }] },
