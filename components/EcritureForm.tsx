  ...
  return (
    <div className="space-y-4">
      <Card className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="reference">Pièce</Label>
        ...
        return (
          <Card key={i} className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-1.5 lg:col-span-2">
              <Label htmlFor={`compte-${i}`}>Compte</Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor={`debit-${i}`}>Débit</Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor={`credit-${i}`}>Crédit</Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor={`dep-${i}`}>Département{analytiqueRequis && ' *'}</Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor={`sec-${i}`}>Secteur / projet</Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor={`camp-${i}`}>Campagne</Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor={`tiers-${i}`}>Tiers</Label>
      ...
      <Card className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <dl className="grid grid-cols-3 gap-4 text-sm">
          <div><dt className="text-foreground-muted">Débit</dt><dd className="font-medium">{formatMontant(totaux.debit, devise)}</dd></div>
          <div><dt className="text-foreground-muted">Crédit</dt><dd className="font-medium">{formatMontant(totaux.credit, devise)}</dd></div>
          <div>
            <dt className="text-foreground-muted">Écart</dt>
            <dd className={totaux.ecart === 0 && totaux.debit > 0 ? 'font-medium text-success' : 'font-medium text-danger'}>
              {formatMontant(totaux.ecart, devise)}
            </dd>
          </div>
        </dl>
